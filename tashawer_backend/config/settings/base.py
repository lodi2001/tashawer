"""
Base Django settings for Tashawer project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='tashawer_db'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Tashawer API',
    'DESCRIPTION': 'Engineering Consultation Marketplace Platform API',
    'VERSION': '1.0.0',
...
# Tashawer Platform Settings
TASHAWER_SETTINGS = {
    # Registration number prefix by city
    'CITY_CODES': {
        'jeddah': 'JD',
        'riyadh': 'RY',
        'dammam': 'DM',
